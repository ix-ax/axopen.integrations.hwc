...
public partial class Component_2 : AXOpen.Core.AxoObject
{
    ...
    public Component_2(AXSharp.Connector.ITwinObject parent, string readableTail, string symbolTail) : base(parent, readableTail, symbolTail)
    {
    ...
    public new async Task<Pocos.Component_2> OnlineToPlainAsync()
    {
        Pocos.Component_2 plain = new Pocos.Component_2();
...
#pragma warning restore CS0612
    ...
    public new async Task<Pocos.Component_2> _OnlineToPlainNoacAsync()
    {
        Pocos.Component_2 plain = new Pocos.Component_2();
#pragma warning disable CS0612
        await base._OnlineToPlainNoacAsync(plain);
...
#pragma warning restore CS0612
    ...
    [Obsolete("This method should not be used if you indent to access the controllers data. Use `OnlineToPlain` instead.")]
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
    protected async Task<Pocos.Component_2> _OnlineToPlainNoacAsync(Pocos.Component_2 plain)
    {
#pragma warning disable CS0612
        await base._OnlineToPlainNoacAsync(plain);
#pragma warning restore CS0612
...
#pragma warning restore CS0612
    ...
    public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(Pocos.Component_2 plain)
    {
...
#pragma warning restore CS0612
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
    public async Task _PlainToOnlineNoacAsync(Pocos.Component_2 plain)
    {
        await base._PlainToOnlineNoacAsync(plain);
#pragma warning disable CS0612
        await this.ExampleCylinder._PlainToOnlineNoacAsync(plain.ExampleCylinder);
...
#pragma warning restore CS0612
    ...
    public new async Task<Pocos.Component_2> ShadowToPlainAsync()
    {
        Pocos.Component_2 plain = new Pocos.Component_2();
    ...
    protected async Task<Pocos.Component_2> ShadowToPlainAsync(Pocos.Component_2 plain)
    {
        await base.ShadowToPlainAsync(plain);
        plain.ExampleCylinder = await ExampleCylinder.ShadowToPlainAsync();
        plain.ActivateManualControl = ActivateManualControl.Shadow;
    ...
    public async Task<IEnumerable<ITwinPrimitive>> PlainToShadowAsync(Pocos.Component_2 plain)
    {
    ...
    ///</summary>
    public new async Task<bool> DetectsAnyChangeAsync(Pocos.Component_2 plain, Pocos.Component_2 latest = null)
    {
        if (latest == null)
    ...
    public new Pocos.Component_2 CreateEmptyPoco()
    {
        return new Pocos.Component_2();
    }
}